export default function Menu() {
  return (
    <div className="navbar px-3 sm:px-4 md:px-6 w-full max-w-[100vw] sm:max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto">
      <div className="flex-1">
        <a className="text-base sm:text-lg md:text-xl lg:text-2xl text-black">daisyUI</a>
      </div>
      <div className="flex gap-2">
        <div className="dropdown dropdown-end">
          <div tabIndex={0} role="button" className=" border-0 avatar hover:cursor-pointer hover:drop-shadow-md ">
